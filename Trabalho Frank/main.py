...
print("Escreva o nome do arquivo, com a extenção. EX: Arquivo.txt")
filename = input()
alfabeto = ['a', 'b', 'c']
teste = True
     ...
     for l in range(1, len(line)):
          ...
          for x in range(0, len(line[l])):
               ...
               if line[l][x] == 'a':
                   ...
                   try:
                         if not(line[l][x+1] == 'b' and line[l][x+2] == 'b'):
                              teste = False
                   except IndexError:
                         teste = False

               elif line[l][x] not in alfabeto:
                    teste = False
